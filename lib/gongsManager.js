...
const handleJsonCourseScheduleRecord = (aJsonCourseScheduleRecord, aCurrentTime = moment().startOf('day')) => {
  ...
  const startDateInterpolatedInMSec = startDateInMSec - courseStartDay * 24 * milSecInHr;
...
class GongsManager {
  ...
  toggleGong(aJsonScheduledCourseGong) {
    ...
    const futureGongTimeInMSec = timeOfCourseStart + exception.getTotalTimeInMsec()
      - startDay * 24 * 3600000;
      
    // Factor in DST offsets as cloneWhileAddingTime does
